...
//   return (
//     <div className="flex sm:flex flex-wrap pt-16 h-screen border border-orange-500">
...
//             <div className="flex w-full max-w-screen overflow-x-auto justify-center lg:px-28 border border-red-500">
//               <TaskTable />
//             </div>
//           )}
...
function ProfilePage() {
  ...
  return (
    ...
    style={{
      ...
      {/* Ícono de hamburguesa visible solo en pantallas pequeñas */}
      <div className="hidden ml-3 z-40 fixed bg-black rounded-sm border border-green-500">
        <button onClick={toggleMenu} className="p-1 text-white" id="hamburger-button">
          {/* Ícono de hamburguesa */}
